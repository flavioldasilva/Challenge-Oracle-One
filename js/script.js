...
const btnEncrypt = document.getElementById('botao-criptografar');
const btnDecrypt = document.getElementById('botao-decriptografar');
const boxCopy = document.getElementById('box-copiar');
const copyText = document.getElementById('caixa-copiar');
const btnCopy = document.getElementById('botao-copiar');
const boxContent = document.getElementById('box-conteudo');
